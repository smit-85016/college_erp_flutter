...
class DashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListenableBuilder(
      ...
      builder: (context, _) {
        final name = currentUser.name.isNotEmpty ? currentUser.name : 'Student';
        final dept = currentUser.department;
        final sem = currentUser.semester;
        ...
        return SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('$sem · B.Tech $dept · JG University',
              ...
              // Metrics
              Row(children: [
                Expanded(child: _MetricCard(label: 'Attendance', value: '84%', subtitle: 'Above 75% min')),
                const SizedBox(width: 12),
                Expanded(child: _MetricCard(label: 'CGPA (Sem 5)', value: '8.4', subtitle: 'Rank 12 / 60')),
              ]),
              const SizedBox(height: 12),
              Row(children: [
                Expanded(child: _MetricCard(label: 'Subjects', value: '6', subtitle: 'This semester')),
                const SizedBox(width: 12),
                Expanded(child: _MetricCard(label: 'Notices', value: '3', subtitle: 'Unread today')),
              ]),
              const SizedBox(height: 16),
              ...
              SectionCard(
                ...
                child: Column(
                  children: AppData.notices.take(3).map((n) => _NoticeRow(n)).toList(),
                ),
              ),
            ],
          ),
...
class _MetricCard extends StatelessWidget {
  ...
  const _MetricCard({required this.label, required this.value, required this.subtitle});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
        ...
        const SizedBox(height: 4),
        Text(subtitle, style: GoogleFonts.nunito(fontSize: 11, color: AppTheme.primary),
            maxLines: 1, overflow: TextOverflow.ellipsis),
      ]),
    );
  }
...
class _ScheduleRow extends StatelessWidget {
  final String time, subject, location;
  final Color chipBg, chipFg;
  const _ScheduleRow(this.time, this.subject, this.location, this.chipBg, this.chipFg);
    ...
    return Padding(
      ...
      child: Row(children: [
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Text(time, style: GoogleFonts.nunito(fontSize: 12, color: AppTheme.textSecondary)),
        ])),
        Container(
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text(notice.date, style: GoogleFonts.nunito(
